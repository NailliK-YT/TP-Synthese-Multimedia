...
public class FloodFill {
     ...
     * @param tolerance Distance maximale pour considérer deux couleurs comme similaires
    ...
    public static BufferedImage remplir(BufferedImage image, int startX, int startY,
        ...
        if (ImageUtil.distanceCouleur(couleurOrigine, nouvelleCouleur) == 0) {
        ...
        while (!file.isEmpty()) {
            ...
            double distance = ImageUtil.distanceCouleur(couleurActuelle, couleurOrigine);
    ...
    public static void remplirRecursif(BufferedImage image, int x, int y,
        ...
        if (ImageUtil.distanceCouleur(couleurActuelle, couleurOrigine) > tolerance) {
            return;
        }
